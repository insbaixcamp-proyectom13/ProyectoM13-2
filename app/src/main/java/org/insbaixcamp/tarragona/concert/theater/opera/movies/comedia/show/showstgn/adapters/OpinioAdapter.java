...
public class OpinioAdapter extends RecyclerView.Adapter<OpinioAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public OpinioAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        this.root = LayoutInflater.from(parent.getContext()).inflate(R.layout.opinio_view, parent, false);
        return new ViewHolder(this.root);
    }

    @Override
    public void onBindViewHolder(@NonNull OpinioAdapter.ViewHolder holder, int position) {
